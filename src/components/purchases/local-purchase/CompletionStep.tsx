    ...
    try {
      ...
      const { data: purchaseDoc, error: purchaseError } = await supabase
        ...
        .insert({
          ...
          exchange_rate: Number(workflowData.exchangeRate) || 1.0,
          subtotal_ht: Number(workflowData.subtotalHt) || 0,
          total_vat: Number(workflowData.totalVat) || 0,
          total_discount: Number(workflowData.totalDiscount) || 0,
          total_ttc: Number(workflowData.totalTtc) || 0,
          stamp_duty_amount: Number(workflowData.stampDutyAmount) || 0,
          net_payable: Number(workflowData.netPayable) || 0,
